  ...
  return (
    ...
    <div className="relative h-64">
      <BackgroundBeamsWithCollision>
        <h2 className="pl-12 flex flex-col relative z-20 text-4xl lg:text-7xl font-bold text-center text-black dark:text-white font-sans tracking-tight">
          Read my thoughts on
    ...
    <div className="ml-[140px] relative p-10 w-fit max-w-4xl mt-14 bg-white/70 rounded-xl border-2 border-black shadow-[4px_4px]">
