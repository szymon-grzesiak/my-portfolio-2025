...
export const metadata: Metadata = {
  title: "Kontakt",
  description: "Skontaktuj się ze Szymonem Grzesiakiem. Omówmy Twój projekt, potrzeby programistyczne lub inne pytania.",
  alternates: {
    canonical: `${siteConfig.url}/pl/contact`,
  },
  openGraph: {
    title: "Kontakt | Szymon Grzesiak",
    description: "Skontaktuj się ze Szymonem Grzesiakiem. Omówmy Twój projekt, potrzeby programistyczne lub inne pytania.",
